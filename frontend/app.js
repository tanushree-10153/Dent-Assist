...
// Doctor photo pools - using randomuser.me for consistent real face photos
...
var femaleNames = ['sanika','tanushree','tanvi','priya','pooja','neha','anjali','sneha','kavya','divya','riya','ananya','shreya','meera','nisha','sonal','rekha','sunita','geeta','lata','asha','usha','radha','sita','gita','puja','swati','shweta','pallavi','madhuri','deepa','seema','reena','mona','sonia','rita','anita','sunita','kavita','lalita','mamta','vandana','archana','kiran','shobha','usha','rani','devi','lakshmi','saraswati','poonam','komal','ramya','astha','lata'];
...
function renderDentistCards(dentists) {
  ...
  for (var i = 0; i < dentists.length; i++) {
    ...
    html += '<div class="dcard">'
      ...
      + '<div class="dcard-avatar" style="background:none;overflow:hidden;"><img src="' + photo + '" alt="Dr. ' + d.name + '" style="width:100%;height:100%;object-fit:cover;border-radius:50%;"/></div>'
